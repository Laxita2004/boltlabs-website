...
const TeamTop = () => {
  ...
  return (
    <div className="bg-[#141e28] relative min-h-[80vh] flex items-center justify-center px-4 overflow-hidden">
      ...
      >
        <h1 className="text-5xl md:text-6xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-[#33febf] to-teal-400 mb-6">
          OUR TEAM
        </h1>
        <p className="text-gray-300 text-lg md:text-xl max-w-3xl mx-auto mb-12">
          Meet the talented individuals who drive our mission forward with
