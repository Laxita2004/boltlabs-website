        ...
        <div className="flex flex-col lg:flex-row bg-gradient-to-br from-[#1e2a38] to-[#202f3e] rounded-3xl overflow-hidden shadow-2xl border border-[#33febf]/30">
            ...
            <div className="space-y-6 text-sm text-gray-200">
              <div className="flex items-center gap-4 group">
                <img
                  src={call}
                  alt="Phone Icon"
                  className="h-6 w-6 invert group-hover:scale-110 transition"
                />
          ...
          <div className="lg:w-1/2 p-10 bg-[#141e28]">
            ...
            >
              ...
              />
              <select className="w-full px-4 py-3 rounded-md bg-white text-[#33febf] border border-[#33febf] focus:outline-none transition">
